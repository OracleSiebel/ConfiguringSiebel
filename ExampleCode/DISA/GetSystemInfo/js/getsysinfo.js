...
// The entire structure of the message is something for the developer to decide, but it must be a JSON object
// or Blob object.
// In this case, the assumption is that the Java code will expect an object with a field called Command having a value
// of GetSysInfo
// Neither "Command" or "GetSysInfo" are DISA-specific, this is just how our plugin example expects the input
